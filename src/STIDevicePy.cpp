...
BOOST_PYTHON_MODULE(STIPy)
{
	...
	//This allows multiple devices to share an orb within a single python instance.
	class_<ORBManagerPy, std::shared_ptr<ORBManagerPy>>("ORBManager")
	//class_<ORBManagerPy>("ORBManager")
		.def("run", &ORBManagerPy::run)
		.def("ORBshutdown", &ORBManagerPy::ORBshutdown)
		;

	class_<MixedValuePy>("MixedValue", 
		"Mixed value class.", init<>("__init__ docstring") )
...
//	class_<SynchronousEventAdapterPy, boost::shared_ptr<SynchronousEventAdapterPy>, boost::noncopyable>("SynchronousEvent", "STI event class.",
	...
	class_<SynchronousEventAdapterPy, std::auto_ptr<SynchronousEventAdapterPy>, 
		boost::noncopyable>("SynchronousEvent", "STI event class.",
...
//		.def("__init__", boost::python::make_constructor(&SynchronousEventAdapterPy::create_event))
		.def("setupEvent", &SynchronousEventAdapterPub::setupEvent_py, 
			&SynchronousEventAdapterPy::default_setupEvent_py)
		.def("loadEvent", &SynchronousEventAdapterPub::loadEvent_py, 
			&SynchronousEventAdapterPy::default_loadEvent_py)
		.def("playEvent", &SynchronousEventAdapterPub::playEvent_py, 
			&SynchronousEventAdapterPy::default_playEvent_py)
		.def("collectMeasurementData", &SynchronousEventAdapterPub::collectMeasurementData_py, 
			&SynchronousEventAdapterPy::default_collectMeasurementData_py)
		;
//boost::python::implicitly_convertible<boost::shared_ptr<SynchronousEventAdapterPy>, boost::shared_ptr<SynchronousEventAdapterPub> >();
	...
	class_<STI_Device_Adapter_Wrapper, boost::noncopyable>("STI_Device", 
		"STI device base class.",
		init<ORBManagerPy&, std::string, std::string, unsigned short>(
			args("Orb", "Device Name", "IP Address", "Module"), "__init__ docstring")
		)
		.def("defineAttributes", &STI_Device_Adapter_Pub::defineAttributes, 
			&STI_Device_Adapter_Wrapper::default_defineAttributes)

		.def("refreshAttributes", &STI_Device_Adapter_Pub::refreshAttributes, 
			&STI_Device_Adapter_Wrapper::default_refreshAttributes)

		.def("updateAttribute", &STI_Device_Adapter_Pub::updateAttribute, 
			&STI_Device_Adapter_Wrapper::default_updateAttribute)

		.def("defineChannels", &STI_Device_Adapter_Pub::defineChannels, 
			&STI_Device_Adapter_Wrapper::default_defineChannels)

		.def("writeChannel", &STI_Device_Adapter_Pub::writeChannel_py, 
			&STI_Device_Adapter_Wrapper::default_writeChannel_py)

		.def("readChannel", &STI_Device_Adapter_Pub::readChannel_py2, 
			&STI_Device_Adapter_Wrapper::default_readChannel_py2)

		.def("definePartnerDevices", &STI_Device_Adapter_Pub::definePartnerDevices, 
			&STI_Device_Adapter_Wrapper::default_definePartnerDevices)

		.def("execute", &STI_Device_Adapter_Pub::execute, 
			&STI_Device_Adapter_Wrapper::default_execute)

		.def("parseDeviceEvents", &STI_Device_Adapter_Pub::parseDeviceEvents_py, 
			&STI_Device_Adapter_Wrapper::default_parseDeviceEvents_py)

		.def("stopEventPlayback", &STI_Device_Adapter_Pub::stopEventPlayback, 
			&STI_Device_Adapter_Wrapper::default_stopEventPlayback)

		.def("pauseEventPlayback", &STI_Device_Adapter_Pub::pauseEventPlayback, 
			&STI_Device_Adapter_Wrapper::default_pauseEventPlayback)

		.def("resumeEventPlayback", &STI_Device_Adapter_Pub::resumeEventPlayback, 
			&STI_Device_Adapter_Wrapper::default_resumeEventPlayback)

		.def("getDeviceHelp", &STI_Device_Adapter_Pub::getDeviceHelp, 
			&STI_Device_Adapter_Wrapper::default_getDeviceHelp)
